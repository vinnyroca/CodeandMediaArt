...
<img src = "../assets/images/11/11_01.png" alt = "image of site with header" style='border:1px solid #000000'></img>
...
<img src = "../assets/images/11/11_02.png" alt = "image of site with header and paragraph" style='border:1px solid #000000'></img>
...
<img src = "../assets/images/11/11_03.png" alt = "image of site with header and paragraph" style='border:1px solid #000000'></img>
...
The `<img>` element can be used to add images to our website. The location of an image is described using the keyword `src`. Typically our source will point to an image with an images folder in our site folder. `alt` is used within the openning carrot brackets to provide alternative text for the image.
...
<img src = "../assets/images/11/11_dog.jpg" alt = "Photograph of Cavalier King Charles Spaniel puppy below a flowering bush" style='border:1px solid #000000'><p> Image courtesy<a href ="https://commons.wikimedia.org/wiki/File:Cute_dog.jpg"> Wikipedia.</a></p> </img>
...
<img src = "../assets/images/11/11_dogs.png" alt = "Photograph of Cute_dog.jpg file within VSCode images folder" style='border:1px solid #000000'> </img>
...
```
<img src = "../assets/images/11/11_04.png" alt = "Screenshot of website with header, p5 sketch, paragraph, link, and image of dog" style='border:1px solid #000000'> </img>
...
<img src = "../assets/images/11/11_05.png" alt = "Screenshot of website with header, p5 sketch, paragraph, link, image of dog, and video of horses from youtube" style='border:1px solid #000000'> </img>
